...
import com.liferay.custom.constants.DDMFormWebKeys;
...
/**
 * @author Maurice Sepe
 * This class overrides the doProcessAction for DDM forms.
 */
@Component(
	immediate = true,
	property = {
...
public class CustomAddFormInstanceRecordMVCActionCommand extends BaseMVCActionCommand {
    ...
    protected void doProcessAction(ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
        ...
        /* 
            modify form formInstanceId based on the created formID 
        */
        if (formInstanceId == 34710) {
            
            HttpPost post = new HttpPost("https://httpbin.org/post");
            post.setHeader("email-address", themeDisplay.getUser().getEmailAddress());
            
            for (DDMFormFieldValue d: ddmFormValues.getDDMFormFieldValues()) {
                post.setHeader(d.getName(), d.getValue().getString(themeDisplay.getLocale()));
            }
